...
@Composable
fun VideosScreen(
    videos: List<MediaItemData>,
    onPlayVideo: (MediaItemData, List<MediaItemData>) -> Unit,
    ...
    if (videos.isEmpty()) {
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Import a local video file or scan device media.",
                    fontSize = 13.sp,
                    color = TextSecondary,
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                    ...
                    OutlinedButton(
                        ...
                        shape = RoundedCornerShape(10.dp),
                        modifier = Modifier.testTag("scan_videos_button")
                    ) {
                        Icon(
